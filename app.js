...
function randomParagraph() {
    ...
    //getting random item form the paragraphs array, splitting all characters
    ...
    if (charIndex < characters.length - 1 && timeLeft > 0) {
        ...
        if (typedChar == null) {
            ...
            if (characters[charIndex].innerText === typedChar) {
                ...
                // correct class else increment the mistakes and add incorrect class
                characters[charIndex].classList.add("correct");
            } else {
                mistakes++;
                characters[charIndex].classList.add("incorrect");
            }
            charIndex++; //incremennt charIndex either user typed correct or incorrect character
        }
...
function resetGame() {
    //calling loadParagraph fucntion and
